...
int meterAX = 50, meterAY = 90, meterAR = 30;
int meterBX = 100, meterBY = 90;
...
void drawBasket(){
    ...
    for(int i=0; i<360; i+=7){
        degree = i * 3.1416 / 180.0;
        glVertex2f(19*cos(degree)+basketX-39, 7*sin(degree)+basketY);
        glVertex2f(20*cos(degree)+basketX-39, 7*sin(degree)+basketY-4);
    }
    glEnd();
    glColor3f (1,0,0);
    glBegin(GL_POINTS);
...
void drawAngleMeter(int degree){
    ...
    for(int i=0; i<90; i++){
        angle = i * 3.1416 / 180.0;
        glVertex2f(meterAR*cos(angle)+meterAX, meterAR*sin(angle)+meterAY+5);
    ...
    glBegin(GL_TRIANGLE_FAN);
    glVertex2f(x+2, y);
    glVertex2f(meterAX,meterAY-2);
    glVertex2f(meterAX-2,meterAY);
    glVertex2f(meterAX,meterAY+2);
    glVertex2f(meterAX+2,meterAY);
    glVertex2f(meterAX,meterAY);
...
void drawSpeedMeter(int height){
    ...
    */
    glVertex2f(meterBX ,meterBY+4 );
    glVertex2f(meterBX ,meterBY);
    glVertex2f(meterBX + 100,meterBY );
    glVertex2f(meterBX + 100 , meterBY +(108/3));
    glEnd();
    ...
    */
    glVertex2f(meterBX ,meterBY+4 );
    glVertex2f(meterBX ,meterBY);
    glVertex2f(meterBX + height,meterBY );
    glVertex2f(meterBX + height , meterBY+4 +h);
